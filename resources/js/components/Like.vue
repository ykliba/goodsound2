<template>
   <div class="like">
     <div v-if="result"  @click="unlike()" class="like_button"><i class="far fa-thumbs-up fa-2x"></i></div>
     <div  v-else  @click="like()" class="like_button"><i class="fas fa-thumbs-up fa-2x"></i></div>
